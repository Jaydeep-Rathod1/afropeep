...
import 'package:afropeep/screens/onboarding_screen/choose_school_college_screen.dart';
                        ...
                        if(_firstName.text.isNotEmpty && _lastName.text.isNotEmpty)
                          {
                            Navigator.push(context, PageTransition(
                                type: PageTransitionType.rightToLeft,
                                child: ChooseSchoolCollege(firstName:_firstName.text.toString(),lastName:_lastName.text.toString(),chooseToStart:widget.chooseToStart,chooseGender:widget.chooseGender)
                            ));
                          }
                        else{
                          setState(() {
