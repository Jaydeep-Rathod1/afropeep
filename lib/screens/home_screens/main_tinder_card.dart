...
class _MainTinderCardState extends State<MainTinderCard> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await getUserQuestionDetails();
    });
    }
  getUserQuestionDetails()async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var userid =prefs.getInt('userid');
    print("userid ofquestions= ${userid}");
    Map<String, String> params = Map();
    params['userid'] = userid.toString();
    Dio _dio = Dio();
    await _dio.post(QUESTIONDONE,data: params).then((value) {
      // var varJson = value.data;
      print("value of questions = ${value}");
      if(value.statusCode == 200)
      {
        print(value.data.toString());
        if(value.data['message'] == "Question Not Answered")
          {
            setState(() {
              isDisplaytooltip = true;
            });
            ...
            children: [
              ...
              Align(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      TextButton(onPressed: (){
                        Navigator.push(context,PageTransition(type: PageTransitionType.rightToLeft, child:  QuestionsScreen()));
                      }, child: Text("Tap"))
                    ],
                  ),
                ),
                  ...
                  :Container(),
              isDisplaytooltip ? SizedBox(height: 10,):Container(),
              Stack(
                children: [
